 ...
 * @author sunhe
 */
@Service(value = "scUpdateOfferStatusServiceDelegate")
public class ScUpdateOfferStatusServiceDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) {
        ...
        if(ProcessTypeEnum.SHELF_PROCESS.getValue() == processType){
            System.out.println("审批通过：处理上架流程");
            //下架流程
        } else if(ProcessTypeEnum.UNSHELF_PROCESS.getValue() == processType){
            System.out.println("审批通过：处理下架流程");
